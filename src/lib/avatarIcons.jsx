import {
  ...
  // Sky & space
  Sun, Moon, Snowflake, Waves, Rainbow, CloudSun,
  MoonStars, ShootingStar, Planet, Lightning, Sparkle, Umbrella,
  // Animals
  ...
  // Activity & sports
  Bicycle, Rocket, Compass, Basketball, SoccerBall, Smiley,
  Barbell, TennisBall, Volleyball, Golf, BowlingBall, Sailboat,
  // Travel
  Airplane, Car, Train, Mountains, Tent, Boat,
  // Fun & misc
  Balloon, Confetti, Popcorn, Anchor, DiceSix, Joystick,
...
export const AVATAR_ICON_LIST = [
  ...
  { name: 'Golf',          Icon: Golf },
  { name: 'BowlingBall',   Icon: BowlingBall },
