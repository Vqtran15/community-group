...
export default function LandingPage() {
  ...
  return (
    <div
      className={`min-h-screen bg-white font-sans transition-all duration-300 ease-in-out ${leaving ? 'opacity-0 translate-y-3' : 'opacity-100 translate-y-0'}`}
    >

      {/* Nav */}
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur border-b border-stone-100 px-6 py-4 flex items-center justify-between">
      ...
      {/* Footer */}
      <footer className="px-6 py-8 bg-stone-900 text-center">
        <span className="font-league-gothic text-xl text-stone-400 tracking-wide">Covey Space</span>
        <p className="text-stone-600 text-xs mt-1">© {new Date().getFullYear()} Covey Space. All rights reserved.</p>
      </footer>
